...
class SubscribedToFlowableTest {

    interface A {
        fun a(): Flowable<String>
        fun b(): Flowable<String>
        fun c(a: String?): Flowable<String>
    }
    ...
    @Before
    fun setUp() {
        mock1 = mock(defaultAnswer = ReturnsTrackedObservables())
        mock2 = mock(defaultAnswer = ReturnsTrackedObservables())
    }
